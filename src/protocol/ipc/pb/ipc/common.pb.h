...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ipc_2fcommon_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ipc_2fcommon_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ipc_2fcommon_2eproto
...
struct TableStruct_ipc_2fcommon_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ipc_2fcommon_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace pb {
namespace ipc {
...
template <> struct is_proto_enum< ::pb::ipc::ResultCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb::ipc::ResultCode>() {
  return ::pb::ipc::ResultCode_descriptor();
}
template <> struct is_proto_enum< ::pb::ipc::DisconnectReason> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb::ipc::DisconnectReason>() {
  return ::pb::ipc::DisconnectReason_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ipc_2fcommon_2eproto
